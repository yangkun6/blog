    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateField(max_length=32, verbose_name=b'\xe5\x8f\x91\xe8\xa1\xa8\xe6\x97\xa5\xe6\x9c\x9f')),
                ('image', models.ImageField(upload_to=b'images', verbose_name=b'\xe6\x96\x87\xe7\xab\xa0\xe5\x9b\xbe\xe7\x89\x87', blank=True)),
                ('content', ckeditor_uploader.fields.RichTextUploadingField(verbose_name=b'\xe6\x96\x87\xe7\xab\xa0\xe5\x86\x85\xe5\xae\xb9', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=32, verbose_name=b'\xe5\x9c\xb0\xe5\x9d\x80', blank=True)),
                ('photo', models.ImageField(upload_to=b'images', verbose_name=b'\xe4\xbd\x9c\xe8\x80\x85\xe7\x85\xa7\xe7\x89\x87', blank=True)),
        ...
        migrations.AddField(
            model_name='article',
            name='author',
            field=models.ForeignKey(to='yk_blog.Author'),
        ),
    ]
